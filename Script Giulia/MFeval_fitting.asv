% First load the data into the workspace For this example, the data is stored as a Table and 
% has been already filtered, cropped and pre-processed. 
% The data in this example is already in ISO-W and all channels in SI units (N, Nm, m, s, rad, Pa)
...
InitalParameterSet = mfeval.readTIR("C:\Users\manue\Documents\GitHub\Alfa_Giulia\Script Giulia\file tir\FRONT_V2Pirelli_Cinturato_AR_Giulia_2.2_JTD_150_AT8_DC_LMUX_OK_LMUY_V2.tir");
%InitalParameterSet = mfeval.readTIR("C:\Users\manue\Documents\GitHub\Alfa_Giulia\Script Giulia\file tir\REAR_V2Pirelli_Cinturato_AR_Giulia_2.2_JTD_150_AT8_DC_LMUX_OK_LMUY_V2.tir");
