...
V_vec=linspace(Vmin,Vmax,N); % vector longitudinal speed Vx

deltaf = [5:5:30];   % [deg]  Input steer angle;
...
for ii=1:numel(deltaf)
   ...
   deltaf_vec = zeros(1,N) + deltaf(ii);  % vector steer angle fixed
    ...
    switch choice_model
        case 1
            [Alfa,Force,Solution] = F_Singletrack_nonlinear_ss_Giulia(V_vec,deltaf_vec,Vehicle,Tyre,N);
        case 2
            [Alfa,Force,Solution,delta] = F_Doubletrack_nonlinear_ss_Giulia(V_vec,deltaf_vec,Vehicle,Tyre,N);
        case 3
            [Alfa,Force,Solution] = F_Singletrack_linear_ss(V_vec,deltaf_vec,Vehicle,Tyre,N);
        case 4    
            [Alfa,Force,Solution,delta] = F_Doubletrack_linear_ss(V_vec,deltaf_vec,Vehicle,Tyre,N);
    end      
    %%     
